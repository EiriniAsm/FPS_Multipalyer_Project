...
public class FPSMouseLook : MonoBehaviour {
	...
	void HandleRotation() {
		...
		}//this is just a precaution. Double check if the sensivity of the mouse is what we set it to be.
		...
		if (axes == RotationAxes.MouseY) {
			...
			//we reverse the value: Now, when the player moves the mouse upwards the camera view moves along. If we used "+rotation_Y" this would be reversed
